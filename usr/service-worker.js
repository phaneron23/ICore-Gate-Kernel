const CACHE_NAME = 'usr-v0.1.0';
const ASSETS = ['/', '/index.html', '/manifest.json',
  '/engine/identity.js', '/engine/execution.js', '/engine/constraints.js',
  '/engine/isolation.js', '/engine/attestation.js', '/engine/orchestration.js',
  '/engine/runtime.js'];
